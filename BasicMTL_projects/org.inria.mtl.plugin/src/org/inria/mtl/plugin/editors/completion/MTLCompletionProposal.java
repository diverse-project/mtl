...
public class MTLCompletionProposal implements IMTLCompletionProposal, ICompletionProposalExtension, ICompletionProposalExtension2 {
	...
	private static boolean insertCompletion() {
		IPreferenceStore preference= MTLPlugin.getDefault().getPreferenceStore();
