...
public class MTLUnitEditor extends MTLEditor {
  ...
  private class BracketInserter implements VerifyKeyListener, LinkedPositionUI.ExitListener {
	...
	public void verifyKey(VerifyEvent event) {
	  ...
	  try {
		...
		if (type.equals(PreferenceConstants.MTL)) {
		  switch (event.character) {
			case '(' :
  ...
  private final static String CLOSE_STRINGS_MTL = PreferenceConstants.EDITOR_CLOSE_STRINGS_MTL;
  ...
  private final static String CLOSE_BRACKETS_MTL = PreferenceConstants.EDITOR_CLOSE_BRACKETS_MTL;
