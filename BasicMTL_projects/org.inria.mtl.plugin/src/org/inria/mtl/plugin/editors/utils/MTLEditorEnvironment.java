/*
* $Id: MTLEditorEnvironment.java,v 1.2 2004-05-19 09:22:10 sdzale Exp $
* Authors : ${user}
*
* Created on ${date}
...
import org.inria.mtl.plugin.editors.MTLCodeScanner;
import org.inria.mtl.plugin.editors.SingleTokenScanner;
...
/**
	...
	public MTLEditorEnvironment(IPreferenceStore store) {
	  ...
	  fMultilineCommentScanner = new SingleTokenScanner(fColorManager, store, PreferenceConstants.MTL_MULTILINE_COMMENT);
	  fSinglelineCommentScanner = new SingleTokenScanner(fColorManager, store, PreferenceConstants.MTL_SINGLELINE_COMMENT);
	  fStringScanner = new SingleTokenScanner(fColorManager, store, PreferenceConstants.MTL_STRING);
