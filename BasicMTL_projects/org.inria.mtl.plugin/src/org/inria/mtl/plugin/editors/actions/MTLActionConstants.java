/*
* $Id: MTLActionConstants.java,v 1.3 2004-05-19 09:21:05 sdzale Exp $
* Authors : ${user}
*
* Created on ${date}
...
public class MTLActionConstants {
   ...
   * (value <code>"org.inria.mtl.plugin.editor.actions.ContentAssist"</code>).
   */
  public static final String CONTENT_ASSIST = "org.inria.mtl.plugin.editors.ContentAssist"; //$NON-NLS-1$
  ...
  /**
	 ...
	 */
  public static final String SHIFT_RIGHT = "org.inria.mtl.plugin.editors.ShiftRight"; //$NON-NLS-1$

  /**
   * Source menu: name of standard Shift Left global action
   * (value <code>"org.inria.mtl.plugin.editors.ShiftLeft"</code>).
   */
  public static final String SHIFT_LEFT = "org.inria.mtl.plugin.editors.ShiftLeft"; //$NON-NLS-1$
   ...
   * (value <code>"org.inria.mtl.plugin.editors.ConvertLineDelimitersToWindows"</code>).
   */
  public static String CONVERT_LINE_DELIMITERS_TO_WINDOWS = "org.inria.mtl.plugin.editors.ConvertLineDelimitersToWindows"; //$NON-NLS-1$

  /**
   * Source menu: name of standard Convert Line Delimiters To UNIX global action
   * (value <code>"org.inria.mtl.plugin.editors.ConvertLineDelimitersToUNIX"</code>).
   */
  public static String CONVERT_LINE_DELIMITERS_TO_UNIX = "org.inria.mtl.plugin.editors.ConvertLineDelimitersToUNIX"; //$NON-NLS-1$

  /**
   * Source menu: name of standardConvert Line Delimiters ToMac global action
   * (value <code>"org.inria.mtl.plugin.editors.ConvertLineDelimitersToMac"</code>).
   */
  public static String CONVERT_LINE_DELIMITERS_TO_MAC = "org.inria.mtl.plugin.editors.ConvertLineDelimitersToMac"; //$NON-NLS-1$

  /**
   * Navigate menu: name of standard Open global action
   * (value <code>"org.inria.mtl.plugin.editors.Open"</code>).
   */
  public static final String OPEN = "org.inria.mtl.plugin.editors.Open"; //$NON-NLS-1$
