 ...
 * "mtl". If a sample multi-page editor (also available
...
public class NewFileWizard extends Wizard implements INewWizard {
	...
	private InputStream openContentStream() {
		String contents =
			"This is the initial file contents for *.mtl file that should be word-sorted in the Preview page of the multi-page editor";
		return new ByteArrayInputStream(contents.getBytes());
	}

	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "org.inria.mtl", IStatus.OK, message, null);
