/**
 * <p>Titre : MTLClassVariableElement </p>
 * <p>Description: Definition d'une variable MTL</p>
...
public class MTLClassVariableElement extends MTLElement
{

	public MTLClassVariableElement(String aName, int offset, int length)
	{
	...
	{	/* Voir MTLImages pour les icones*/
		return MTLImages.ICON_VIEW_CLASS_VARIABLE;
	}
