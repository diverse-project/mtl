/*
* $Id: MTLEditor1.java,v 1.1 2004-07-30 14:10:05 sdzale Exp $
* Authors : ${user}
*
* Created on ${date}
...
import org.inria.mtl.editors.actions.MTLCompileAction;
...
import org.inria.mtl.editors.utils.IJavaAnnotation;
...
public abstract class MTLEditor1 extends StatusTextEditor implements IViewPartInputProvider { // extends TextEditor {
		...
		class MouseClickListener implements KeyListener, MouseListener, MouseMoveListener,
			...
			public void propertyChange(PropertyChangeEvent event) {
				if (event.getProperty().equals(MTLEditor1.LINK_COLOR)) {
			...
			private void updateColor(ISourceViewer viewer) {
				...
				fColor= createColor(getPreferenceStore(), MTLEditor1.LINK_COLOR, display);
			}
...
//				activateCursor(viewer);												
		...
		class InformationDispatchAction extends TextEditorAction {
			...
			public InformationDispatchAction(ResourceBundle resourceBundle, String prefix, final TextOperationAction textOperationAction) {
				super(resourceBundle, prefix, MTLEditor1.this);
		...
		protected final static String LINE_NUMBER_RULER= PreferencesConstants.EDITOR_LINE_NUMBER_RULER;
		/** Preference key for the foreground color of the line numbers */
		protected final static String LINE_NUMBER_COLOR= PreferencesConstants.EDITOR_LINE_NUMBER_RULER_COLOR;
		/** Preference key for the link color */
		protected final static String LINK_COLOR= PreferencesConstants.EDITOR_LINK_COLOR;
		...
		protected final static String ERROR_INDICATION= PreferencesConstants.EDITOR_PROBLEM_INDICATION;
		/** Preference key for error color */
		protected final static String ERROR_INDICATION_COLOR= PreferencesConstants.EDITOR_PROBLEM_INDICATION_COLOR;
		/** Preference key for warning indication */
		protected final static String WARNING_INDICATION= PreferencesConstants.EDITOR_WARNING_INDICATION;
		/** Preference key for warning color */
		protected final static String WARNING_INDICATION_COLOR= PreferencesConstants.EDITOR_WARNING_INDICATION_COLOR;
		/** Preference key for task indication */
		protected final static String TASK_INDICATION= PreferencesConstants.EDITOR_TASK_INDICATION;
		/** Preference key for task color */
		protected final static String TASK_INDICATION_COLOR= PreferencesConstants.EDITOR_TASK_INDICATION_COLOR;
		/** Preference key for bookmark indication */
		protected final static String BOOKMARK_INDICATION= PreferencesConstants.EDITOR_BOOKMARK_INDICATION;
		/** Preference key for bookmark color */
		protected final static String BOOKMARK_INDICATION_COLOR= PreferencesConstants.EDITOR_BOOKMARK_INDICATION_COLOR;
		/** Preference key for search result indication */
		protected final static String SEARCH_RESULT_INDICATION= PreferencesConstants.EDITOR_SEARCH_RESULT_INDICATION;
		/** Preference key for search result color */
		protected final static String SEARCH_RESULT_INDICATION_COLOR= PreferencesConstants.EDITOR_SEARCH_RESULT_INDICATION_COLOR;
		/** Preference key for unknown annotation indication */
		protected final static String UNKNOWN_INDICATION= PreferencesConstants.EDITOR_UNKNOWN_INDICATION;
		/** Preference key for unknown annotation color */
		protected final static String UNKNOWN_INDICATION_COLOR= PreferencesConstants.EDITOR_UNKNOWN_INDICATION_COLOR;
		/** Preference key for shwoing the overview ruler */
		protected final static String OVERVIEW_RULER= PreferencesConstants.EDITOR_OVERVIEW_RULER;
		/** Preference key for error indication in overview ruler */
		protected final static String ERROR_INDICATION_IN_OVERVIEW_RULER= PreferencesConstants.EDITOR_ERROR_INDICATION_IN_OVERVIEW_RULER;
		/** Preference key for warning indication in overview ruler */
		protected final static String WARNING_INDICATION_IN_OVERVIEW_RULER= PreferencesConstants.EDITOR_WARNING_INDICATION_IN_OVERVIEW_RULER;
		/** Preference key for task indication in overview ruler */
		protected final static String TASK_INDICATION_IN_OVERVIEW_RULER= PreferencesConstants.EDITOR_TASK_INDICATION_IN_OVERVIEW_RULER;
		/** Preference key for bookmark indication in overview ruler */
		protected final static String BOOKMARK_INDICATION_IN_OVERVIEW_RULER= PreferencesConstants.EDITOR_BOOKMARK_INDICATION_IN_OVERVIEW_RULER;
		/** Preference key for search result indication in overview ruler */
		protected final static String SEARCH_RESULT_INDICATION_IN_OVERVIEW_RULER= PreferencesConstants.EDITOR_SEARCH_RESULT_INDICATION_IN_OVERVIEW_RULER;
		/** Preference key for unknown annotation indication in overview ruler */
		protected final static String UNKNOWN_INDICATION_IN_OVERVIEW_RULER= PreferencesConstants.EDITOR_UNKNOWN_INDICATION_IN_OVERVIEW_RULER;
	...
	/** The standard action groups added to the menu */
		...
		public void editorContextMenuAboutToShow(IMenuManager menu) {
			...
			menu.appendToGroup(ITextEditorActionConstants.GROUP_UNDO, new Separator(PreferencesConstants.GROUP_OPEN));	
			menu.insertAfter(PreferencesConstants.GROUP_OPEN, new GroupMarker(PreferencesConstants.GROUP_SHOW));	
...
//	
		...
		public Object getAdapter(Class key) {
			...
			if (key.equals(IContentOutlinePage.class))
			{
				...
				outlinePage.addSelectionChangedListener(fSelectionChangedListener);
				return outlinePage;
			}
...
//			if (MTLPlugin.getDefault().getPreferenceStore().getBoolean(PreferencesConstants.AUTO_COMPILE)) {
