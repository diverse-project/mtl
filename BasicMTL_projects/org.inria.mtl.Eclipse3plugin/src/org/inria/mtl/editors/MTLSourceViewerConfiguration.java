...
public class MTLSourceViewerConfiguration extends SourceViewerConfiguration {
	 ...
	 * 
	 */
	public final static String PREFERENCE_TAB_WIDTH= PreferencesConstants.EDITOR_TAB_WIDTH;
	/** 
	 * Preference key for inserting spaces rather than tabs.
	 * 
	 */
	public final static String SPACES_FOR_TABS= PreferencesConstants.EDITOR_SPACES_FOR_TABS;
	...
	public IAutoIndentStrategy getAutoIndentStrategy(ISourceViewer sourceViewer, String contentType) {
		if (MTLPartitionScanner.MTL_DOC.equals(contentType) ||
			...
			return new MTLAutoIndentStrategy();
...
//		rule for MTL string
	...
	public boolean getAutomaticOutliningPreference()
		{
			return getPreferenceStore().getBoolean(PreferencesConstants.P_AUTO_OUTLINE);	
		}
