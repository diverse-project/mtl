...
import org.inria.mtl.editors.utils.MTLActionConstants;
...
//	character encoding
  ...
  public void contributeToMenu(IMenuManager menu) {
	...
	if (editMenu != null) {
	  editMenu.add(new Separator(PreferencesConstants.GROUP_OPEN));
	  editMenu.add(new Separator(PreferencesConstants.GROUP_GENERATE));
	  editMenu.add(new Separator(PreferencesConstants.GROUP_ADDITIONS));
