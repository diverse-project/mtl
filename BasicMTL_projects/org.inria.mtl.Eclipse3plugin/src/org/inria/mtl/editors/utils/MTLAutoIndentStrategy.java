/*
* $Id: MTLAutoIndentStrategy.java,v 1.2 2004-08-26 12:40:06 sdzale Exp $
* Authors : ${user}
*
* Created on ${date}
...
import org.inria.mtl.preferences.*; 

/**
 * Auto indent strategy sensitive to brackets.
 */

public class MTLAutoIndentStrategy extends DefaultAutoIndentStrategy {
	 ...
	 */
	 protected void smartIndentAfterNewLine(IDocument document, DocumentCommand command) {
		...
		try {
			...
			System.out.println(MTLMessages.getString("AutoIndent.error.bad_location_1")); //$NON-NLS-1$
		}
	}
	 ...
	 */
	 protected void smartInsertAfterBracket(IDocument document, DocumentCommand command) {
		...
		try {
			...
			System.out.println(MTLMessages.getString("AutoIndent.error.bad_location_2")); //$NON-NLS-1$
		}
	}
}
