/*
* $Id: AbstractMTLScanner.java,v 1.2 2004-08-26 12:40:05 sdzale Exp $
* Authors : ${user}
*
* Created on ${date}
 ...
 */
public abstract class AbstractMTLScanner extends BufferedRuleBasedScanner {
	 ...
	 */
	public AbstractMTLScanner(IColorManager manager, IPreferenceStore store) {
		super();
