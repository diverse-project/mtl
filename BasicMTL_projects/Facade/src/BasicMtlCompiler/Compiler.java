/*
 * $Header: /tmp/cvs2svn/cvsroot/BasicMTL_projects/Facade/src/BasicMtlCompiler/Compiler.java,v 1.1 2003-10-14 07:31:56 jpthibau Exp $
	...
	public static void main(String[] args)
	{
		...
		if (args.length > 0) {
			...
			if (filenamesArguments.size() == 0)
			{
				...
				BasicMtlLibrary theLib=(BasicMtlLibrary)TLLtypechecking.checkedTLLProducer(filenamesArguments,defaultPackagePrefix,defaultTLLPath,TLLLoadingPaths,null);
				if (theLib!=null)
