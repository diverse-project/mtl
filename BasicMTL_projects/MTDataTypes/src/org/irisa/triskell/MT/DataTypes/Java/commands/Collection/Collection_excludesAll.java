 ...
 * $Id: Collection_excludesAll.java,v 1.2 2004-02-16 17:01:52 dvojtise Exp $
 * @author : ffondeme 
 * 
...
/**
 * Definition of the ExcludesAll command for Collection
 */
public class Collection_excludesAll extends AbstractCommand {
	public static final Collection_excludesAll TheInstance = new Collection_excludesAll();

	protected Collection_excludesAll() {
		super("excludesAll", new Type [] {CollectionType.getCollectionType(OclAnyType.TheInstance)}, null);
	}
