 ...
 * </copyright>
 *
 * $Id: SimpleUMLActionBarContributor.java,v 1.1 2004-08-10 12:11:41 dvojtise Exp $
 */
  ...
  implements ISelectionChangedListener
{
  ...
  protected IAction showPropertiesViewAction =
    new Action(SimpleUMLEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
      public void run()
      {
        try
  ...
  protected IAction refreshViewerAction =
    new Action(SimpleUMLEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
  ...
  public void contributeToMenu(IMenuManager menuManager)
  {
    ...
    IMenuManager submenuManager = new MenuManager(SimpleUMLEditorPlugin.INSTANCE.getString("_UI_SimpleUMLEditor_menu"), "SimpleUMLMenuID");
    ...
    //
    createChildMenuManager = new MenuManager(SimpleUMLEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    createSiblingMenuManager = new MenuManager(SimpleUMLEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
  ...
  public void menuAboutToShow(IMenuManager menuManager)
  {
    ...
    submenuManager = new MenuManager(SimpleUMLEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    populateManager(submenuManager, createChildActions, null);
    menuManager.insertBefore("additions", submenuManager);

    submenuManager = new MenuManager(SimpleUMLEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
