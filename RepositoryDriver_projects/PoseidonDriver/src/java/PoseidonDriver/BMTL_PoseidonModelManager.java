...
public class BMTL_PoseidonModelManager extends PoseidonModelManager implements BMTLObjectInterface, Value {
	...
	public static final Type TheType = new InstanciableType () {
     ...
     public boolean isKindOf(
        ...
        return v instanceof BMTL_PoseidonModelManager;
     }
	 ...
	 public Value instanciate() {
		return new BMTL_PoseidonModelManager();
	 }

	 public Value instanciateFromJavaObject (Object javaObject)
	 {
		 // currently, no java object allows to create a BMTL_PoseidonModelManager 
	...
	public BMTL_PoseidonModelManager() {
		super();
	}
