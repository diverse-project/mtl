 ...
 */
package org.irisa.triskell.MT.repository.PoseidonDriver.Java;


import java.util.*;
import java.io.*;

// MTL and GenericDriver imports
 ...
 */
public class PoseidonModelManager {

	protected Hashtable managedAPIs; 
	protected Hashtable managedShutDownHooks;	// only added Model will be managed
												// retrieved models aren't managed
	protected boolean isInitialized = false;
	protected static final org.apache.log4j.Logger log = Logger.getLogger("PoseidonDriver");
	
	// Singleton Management
	protected static PoseidonModelManager managerInstance;	// for use as a singleton
	/**
	 * Returns the singleton instance
	 */
	public static PoseidonModelManager getDefault()
	{
	...
	public static org.apache.log4j.Logger getLog () {
			return PoseidonModelManager.log;
	}
	 ...
	 */
	public PoseidonModelManager init() throws Exception{
		...
		try {			
				...
				public Class defineClass(String className, byte[] classFile) {
					try {
						...
						if (byteCodeDir != null && byteCodeDir.length() != 0) {
							...
							if (! outFile.exists()) {
								PoseidonModelManager.getLog().debug("Archiving bytecode for class " + className);
			...
			filePath = new java.io.File(Directories.getRootPath(PoseidonModelManager.class.getName()) + "/log4j_configuration.xml").getCanonicalPath();
			LogManager.resetConfiguration();
			DOMConfigurator.configure(filePath);
			LogManager.getRootLogger().debug("looking for log4jconfiguration file here: "+filePath);
			PoseidonModelManager.getLog().info("Poseidon driver initialized...");
			isInitialized = true;	
			return this;
		} 
		catch (Exception e) {
			PoseidonModelManager.getLog().error("Poseidon driver bugged !!!", e);
	...
	public static void main (String [] args) {
		try {
			PoseidonModelManager aPoseidonModelManager = new PoseidonModelManager();		
			aPoseidonModelManager.init();
			System.exit(0);
		} catch (Exception x) {
			x.printStackTrace();
			System.exit(-1);
