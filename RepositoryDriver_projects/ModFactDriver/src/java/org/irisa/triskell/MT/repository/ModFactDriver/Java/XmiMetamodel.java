/*
 * $Id: XmiMetamodel.java,v 1.1 2004-10-25 13:57:14 dvojtise Exp $
    ...
    extends org.irisa.triskell.MT.repository.genericJMIDriver.Metamodel
{
        ...
        throws java.lang.Exception
    {
			...
			while (it.hasNext() && (metaPackageToInstanciate == null || rp == null)) {
				...
				if (	(o instanceof MofPackage)
					...
					if (metaPackageToInstanciate != null)
						throw new /*CreationFailed*/ Exception("Multiple meta package can be instanciated; please, select one explicitly.");
			...
			if (metaPackageToInstanciate == null)
				throw new /*CreationFailed*/Exception("Cannot find meta package to instanciate; check name; note this package must be a root package");
