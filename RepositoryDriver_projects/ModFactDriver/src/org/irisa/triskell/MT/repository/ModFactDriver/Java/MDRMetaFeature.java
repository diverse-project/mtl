...
{
    private final org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRMetaClass scope;

    private final String name;

    private List delegates;
    protected org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRMetaFeature getDelegates (int i) {
        return (org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRMetaFeature)this.delegates.get(i);
    }
    ...
    protected MDRMetaFeature(
        ...
        org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRMetaFeature[] delegates)
    {
        super(api, null);
		this.name = name;
    	this.scope = scope;
