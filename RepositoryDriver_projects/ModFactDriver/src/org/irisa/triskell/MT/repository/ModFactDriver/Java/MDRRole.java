...
{
    private final org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRMetaAssociationEnd associationEnd;

    private final org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRFeatured element;


    public MDRRole(
        org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRFeatured element,
        org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRMetaAssociationEnd associationEnd)
    {
