    ...
    extends org.irisa.triskell.MT.repository.ModFactDriver.Java.Metamodel
{
        ...
        throws java.lang.Exception
    {
		...
		RefPackage metamodelModel = api.getModfactRepository().getExtent(this.getMetamodelPackageName());
		...
		return api.getModfactRepository().createExtent(api.getModelName(), (MofPackage)metaPackageToInstanciate);
    }
}
