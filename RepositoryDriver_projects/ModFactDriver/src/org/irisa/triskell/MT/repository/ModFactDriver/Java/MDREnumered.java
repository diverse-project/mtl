...
{
    private final org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRMetaEnumeration type;

    private final javax.jmi.reflect.RefEnum refEnum;


    public MDREnumered(
        org.irisa.triskell.MT.repository.ModFactDriver.Java.MDRMetaEnumeration type,
