...
import org.irisa.triskell.MT.repository.MDRDriver.Java.events.MDRAssociationEventListener;
import org.irisa.triskell.MT.repository.MDRDriver.Java.events.MDRAttributeEvent;
import org.irisa.triskell.MT.repository.MDRDriver.Java.events.MDRAttributeEventListener;
import org.irisa.triskell.MT.repository.MDRDriver.Java.events.MDREventListenerCommand;
import org.irisa.triskell.MT.repository.MDRDriver.Java.events.MDRInstanceEvent;
import org.irisa.triskell.MT.repository.MDRDriver.Java.events.MDRInstanceEventListener;
...
public class Test1 extends TestCommand 
{
	...
	public Object mainExecute (Object context) throws Exception  
	{
		...
		////////////////////////////////////////////////////////////////////////////////
        mc_Class.addListener (
        	new MDRAttributeEventListener (
        		getAPI(), 
				new MDREventListenerCommand () {
        			public void execute(Event e) {
        		    	getAPI().getLog().info ("ATTRIBUTE kind : " + ((MDRAttributeEvent)e).getKind() + "  source : " + e.getSource());
        			}
        		}
			)
		);
		...
		////////////////////////////////////////////////////////////////////////////////
        mc_Class.addListener (
        	new MDRInstanceEventListener (
        		getAPI(), 
				new MDREventListenerCommand () {
        			public void execute(Event e) {
        				getAPI().getLog().info ("INSTANCE kind : " + ((MDRInstanceEvent)e).getKind());
        			}
        		}
			)
		);
		...
		////////////////////////////////////////////////////////////////////////////////
        mc_Class.addListener (
        	new MDRAssociationEventListener (
        		getAPI(), 
				new MDREventListenerCommand () {
        			public void execute(Event e) {
        				getAPI().getLog().info ("ASSOCIATION kind : " + ((MDRAssociationEvent)e).getKind());
        			}
        		}
			)
		);
