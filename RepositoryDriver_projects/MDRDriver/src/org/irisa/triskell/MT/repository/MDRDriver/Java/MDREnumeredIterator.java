...
{
    private final org.irisa.triskell.MT.repository.MDRDriver.Java.MDRMetaEnumeration enumeration;

    private int index = 0;


    public MDREnumeredIterator(
        org.irisa.triskell.MT.repository.MDRDriver.Java.MDRMetaEnumeration enumeration)
    {
